      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-2">
          <CardHeader className="text-center">
            ...
            <CardDescription>ابدأ رحلتك مع Keynova Lock مجاناً</CardDescription>
          </CardHeader>
            ...
            <form className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="firstName" placeholder="أحمد" className="text-right" required />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="lastName">الاسم الأخير</Label>
                  <Input id="lastName" placeholder="محمد" className="text-right" required />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="company" placeholder="شركة التقنية المتقدمة" className="text-right" />
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start space-x-2 space-x-reverse">
                  ...
                  <Label htmlFor="newsletter" className="text-sm">
                    أرغب في تلقي التحديثات والعروض الخاصة عبر البريد الإلكتروني
                  </Label>
                </div>
              </div>
